...
const SeamlessDataTransformation = () => {
        ...
        <div className="w-full max-w-none items-center gap-x-[8.75em] gap-y-[8.75em] justify-center mx-auto grid md:grid-cols-2">
          <div className="w-full md:p-8 flex flex-col items-center  md:gap-10 gap-5">
            ...
            <p className="text-defaultIconColor flex-[0_auto] w-full md:text-[1.13em] leading-[1.4] text-[16px] font-normal md:leading-[160%] no-underline block  text-center ">
              Our sophisticated interface empowers you to streamline and
              automate data transformation workflows, leveraging
          ...
          <ul className="mt-10 md:gap-[2em] text-defaultIconColor z-[50] w-full">
              ...
              <div className="grid overflow-hidden transition-all duration-300 ease-in-out text-slate-600 text-sm">
                ...
                >
                  <p className="effortlessAccordionP">
                    ...
                    systems to define your source and target for data
                    transformation.
                  </p>
                </div>
              </div>
            ...
            >
              ...
              <div className="grid overflow-hidden transition-all duration-300 ease-in-out text-slate-600 text-sm">
                ...
                >
                  <p className="effortlessAccordionP">
                    Use our no-code interface or custom scripting for advanced
                    needs. Utilize our pre-built transformation templates to
                    simplify and expedite the setup.
                  </p>
                </div>
              </div>
            </li>
            ...
            >
              ...
              <div className="grid overflow-hidden transition-all duration-300 ease-in-out text-slate-600 text-sm">
                ...
                >
                  <p className="effortlessAccordionP">
                    Test and validate each step with our integrated suite to
                    ensure data accuracy and reliability. Guarantee your data
            ...
            >
              ...
              <div className="grid overflow-hidden transition-all duration-300 ease-in-out text-slate-600 text-sm">
                ...
                >
                  <p className="effortlessAccordionP">
                    Set your transformation schedule and deploy the workflow for
                    automated and consistent data processing.
                  </p>
                </div>
              </div>
            </li>
...
export default SeamlessDataTransformation;
